    ...
    <Layout>
      <div className="p-6 max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold text-[#04342C]">💰 Float Income</h2>
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => setShowForm(!showForm)}
              className="text-sm bg-[#0F6E56] text-white px-4 py-1.5 rounded-lg hover:bg-[#085041] transition-colors">
              + Record Float
            </button>
          </div>
        </div>
        ...
        {data && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-4">
              ...
              <p className="text-2xl font-bold text-[#0F6E56]">KES {parseFloat(data.totalReturned || 0).toLocaleString()}</p>
            </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#9FE1CB]"
                />
              </div>
              <div>
            ...
            <div className="flex gap-3">
              <button onClick={handleSubmit} disabled={submitting}
                className="bg-[#0F6E56] text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-[#085041] disabled:opacity-50 transition-colors">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {data.transactions.map((tx: any) => (
                    <tr key={tx.id} className="border-b border-slate-50 hover:bg-slate-50">
                      ...
                      <td className="py-3 px-4 text-[#0F6E56]">KES {parseFloat(tx.amount_returned).toLocaleString()}</td>
                ...
                <tfoot className="bg-slate-50 border-t border-slate-200">
                  <tr>
                    ...
                    <td className="py-3 px-4 font-semibold text-[#0F6E56]">KES {parseFloat(data.totalReturned || 0).toLocaleString()}</td>
