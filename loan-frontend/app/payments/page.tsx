...
export default function PaymentsPage() {
  ...
  const [form, setForm] = useState({ loan_id: "", amount: "", transaction_code: "", source: "mpesa" } as { loan_id: string; amount: string; transaction_code: string; source: string });
  ...
  const loadData = async () => {
    const p = await getPayments() as Payment[];
