...
function ScheduleContent() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-[#04342C]">Repayment Schedule</h2>
        ...
        <>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-lg shadow p-4">
              ...
              <p className="text-xl font-bold text-[#0F6E56]">KSh {totalDue.toLocaleString()}</p>
            </div>
            <div className="bg-white rounded-lg shadow p-4">
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b flex justify-between items-center">
              ...
              <button onClick={() => window.print()} className="text-sm text-[#0F6E56] hover:underline print:hidden">🖨 Print</button>
            </div>
            {loading ? (
