...
if (!fs.existsSync('loan-frontend/app/slip')) {
  fs.mkdirSync('loan-frontend/app/slip', { recursive: true });
}

fs.writeFileSync('loan-frontend/app/slip/page.tsx', `"use client";
...
console.log('✅ Payment slip page created at loan-frontend/app/slip/page.tsx');
console.log('');
console.log('📋 Next step — add NEXT_PUBLIC_KCB_PAYBILL to loan-frontend/.env.local:');
console.log('   NEXT_PUBLIC_KCB_PAYBILL=your_paybill_number');
console.log('');
console.log('🌐 Visit: http://localhost:3000/slip');
