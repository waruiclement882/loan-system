              ...
              {loans.slice(0, 5).map((loan: any) => {
                ...
                return (
                  <tr key={loan.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-2">
                      <span className={"px-2 py-1 rounded-full text-xs " + (loan.status === "paid" ? "bg-green-100 text-green-700" : loan.status === "active" ? "bg-blue-100 text-blue-700" : loan.status === "rejected" ? "bg-red-100 text-red-700" : "bg-yellow-100 text-yellow-700")}>
                        {loan.status}
                      </span>
                    </td>
                  </tr>
...
fs.writeFileSync('loan-frontend/app/dashboard/page.tsx', content, 'utf8');
console.log('Done!');
