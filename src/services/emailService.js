  ...
  await sendEmail({
    ...
    html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
      ...
      <table style="width:100%;border-collapse:collapse;margin:20px 0;">
        ...
        <tr><td style="padding:8px;border:1px solid #e5e7eb;">Transaction Code</td><td style="padding:8px;border:1px solid #e5e7eb;">${payment.transaction_code || payment.kcb_transaction_id || '-'}</td></tr>
